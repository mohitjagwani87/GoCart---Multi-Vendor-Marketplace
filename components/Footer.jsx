...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "contact@mohitjag.com", path: 'mailto:contact@mohitjag.com', icon: MailIcon },
                { text: "Zike road bangalore", path: '/', icon: MapPinIcon },
                { text: "9109883022", path: 'tel:9109883022', icon: PhoneIcon }
            ]
        }
    ];

    const socialIcons = [
        { icon: Github, link: "https://github.com/mohitjagwani87" },
        { icon: Linkedin, link: "https://www.linkedin.com/in/mohit-kumar-jagwani-68b607251/" },
    ]
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3 mt-5">
                            {socialIcons.map((item, i) => (
                                <a key={i} href={item.link} target="_blank" rel="noreferrer" className="flex items-center justify-center w-10 h-10 bg-slate-100 hover:scale-105 hover:border border-slate-300 transition rounded-full">
                                    <item.icon size={20} />
                                </a>
                            ))}
                        </div>
